...
let wiki_project_mass.css_name = 'style.css'
let wiki_project_mass.auto_export = 1
let wiki_project_mass.diary_index = 'index'
let wiki_project_mass.template_default = 'default'
let wiki_project_mass.auto_toc = 1
let wiki_project_mass.auto_tags = 0
let wiki_project_mass.nested_syntaxes = g:filetype_aliases
let wiki_project_mass.diary_sort = 'desc'
let wiki_project_mass.path = 'C:/Users/tlincoln/Source/Workspace/MASS/wiki/'
let wiki_project_mass.path_html = wiki_project_mass.path . '../wiki_html/'
let wiki_project_mass.template_path = wiki_project_mass.path . 'templates/'
let wiki_project_mass.diary_link_fmt = '%Y-%m-%d'
let wiki_project_mass.template_ext = '.tpl'
let wiki_project_mass.syntax = 'default'
let wiki_project_mass.custom_wiki2html = ''
let wiki_project_mass.automatic_nested_syntaxes = 1
let wiki_project_mass.index = 'index'
let wiki_project_mass.diary_header = 'Diary'
let wiki_project_mass.ext = '.wiki'
